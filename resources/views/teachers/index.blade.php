                                ...
                                <div class="widget-content-left">
                                    <div class="btn-group">
                                        ...
                                        <div tabindex="-1" role="menu" aria-hidden="true" class="dropdown-menu dropdown-menu-right">
                                            ...
                                            <button type="button" tabindex="0" class="dropdown-item">تنظمیات پنل کاربری</button>
            ...
            <div class="theme-settings__inner">
                <div class="scrollbar-container">
                    <div class="theme-settings__options-wrapper">
                        <h3 class="themeoptions-heading">تنظمیات و پشتیبانی
                        </h3>
                        <!-- <div class="p-3">
                            <ul class="list-group">
                    ...
                    <div class="app-header__menu">
                        ...
                        <div class="app-sidebar__inner">
                            <ul class="vertical-nav-menu">
                                <li class="app-sidebar__heading"> داشبورد اساتید</li>
                                <li>
                                ...
                                <li class="app-sidebar__heading">داوری مقالات</li>
                                <li     
                                >
                                    <a href="/teacher/jury-abstract">
                                        <i class="metismenu-icon pe-7s-diamond"></i>
                                         داوری چکیده مقالات
                                    @if(App\Article::where('teacher',Auth::user()->id)->where('verify','0')->count() > 0)
                                             <span class="badge badge-pill badge-info">
                                                  {{App\Article::where('teacher',Auth::user()->id)->where('verify','0')->count()}}
                                             </span>
                                    @elseif(App\Article::where('teacher',Auth::user()->id)->where('verify','2')->count() > 0)
                                             <span class="badge badge-pill badge-primary">
                                                  {{App\Article::where('teacher',Auth::user()->id)->where('verify','2')->count()}}
                                             </span>    
                            ...
                            <li
                                ...
                                >
                                    <a href="/teacher/jury-final">
                                        <i class="metismenu-icon pe-7s-car"></i>
                                        داوری مقالات نهایی
                                        @if(App\Article::where('teacher',Auth::user()->id)->where('verify2','1')->orwhere('verify2','3')->count() > 0)
                                        <span class="badge badge-pill badge-info">
                                                  {{App\Article::where('teacher',Auth::user()->id)->where('verify2','1')->orwhere('verify2','3')->count()}}
                                             </span>
